...
<div class="container">    
    <div class="parents">
        ...
        echo "<tr>
            ...
            <a href ='modifier.php?gm=$value[gmail] & nm=$value[nom] & pn=$value[prenom] & dn=$value[dtn] & tp=$value[tele] & md=$value[maladie]'><input type='image'  src='action_ajouter.png'></a></div></td>
            </tr>";
